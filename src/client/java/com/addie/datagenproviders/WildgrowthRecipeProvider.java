package com.addie.datagenproviders;
...
public class WildgrowthRecipeProvider extends FabricRecipeProvider {
    ...
    public WildgrowthRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    private Identifier getStonecuttingIdentifier(Block in, Block out) {
        return Wildgrowth.id(fixupBlockKey(in.getTranslationKey()) + "_to_" + fixupBlockKey(out.getTranslationKey()) + "_stonecutting");
    }
